...
export default function JobDetailClient({ jobId: initialJobId }: { jobId?: string }) {
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 py-8 space-y-8">
      ...
      {/* Main Grid: Description + Automation Sidebar */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        {/* Right 1 Col: Automation Assistance & Tailored Resume */}
        <div className="space-y-6">
          {/* Automated Tailoring Card */}
          <div className="rounded-2xl border border-blue-200 bg-gradient-to-br from-blue-50/60 to-white p-6 shadow-card space-y-4">
            ...
            <p className="text-xs text-text-secondary leading-relaxed">
              Let automation re-align your profile achievements and inject keywords from this specific JD to maximize your interview odds.
            </p>
